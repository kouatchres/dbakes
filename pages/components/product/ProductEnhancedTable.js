...
const ProductEnhancedTable = ({
  ...
  const [deleteAProductMutation, { data: dataProductDelete, loading, error }] =
    useDeleteAProductMutation();
    ...
    <TableContainer style={{ paddingBottom: '1rem' }}>
      ...
      <MaUTable {...getTableProps()}>
        ...
        <ConfirmDialog
          ...
          content="Do you realy want to delete this product?"
        ...
        >
          <UpdateProduct id={isUpdatePopupOpen.id} />
        </UpdatePopup>
      </MaUTable>
...
export default ProductEnhancedTable;
